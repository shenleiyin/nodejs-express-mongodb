...
const CheckIn = require("../../../models/Rooms/CheckIn");
const validateCheckInInput = require("../../../validation/checkin");


// $route  GET /api/rooms/checkin/test
// @desc   返回的请求的json数据
// @access public
...
// $route  GET /api/rooms/checkin
// @desc   获取当前登录用户的个人信息
// @access private
router.get("/", passport.authenticate('jwt', { session: false }), (req, res) => {
    const errors = {};
    CheckIn.findOne({ user: req.user.id })
