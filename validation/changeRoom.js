...
module.exports = function validateChangeRoomInput(data) {
    let errors = {};
    //身份证正则表达
    ...
    data.poomType = !isEmpty(data.poomType) ? data.poomType : '';
    ...
    if (Validator.isEmpty(data.poomType)) {
        errors.poomType = "房价类型不能为空!";
    }
